                ...
                <div className="container mt-5">
                    <div className='sellingproducts'>
                        <div className="row row-cols-1 row-cols-md-4 g-3" id='sellingproduct_container1'>
                            <div className="col">
                                <div className="card h-75 w-80 pb-5 card_boxShadow" id='card_hight'>
                            ...
                            <div className="col">
                                <div className="card h-75 w-80 pb-5 card_boxShadow">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <h5 className="card-title"> <del>Rs.1150</del> Rs.949</h5>
                                    </div>
                                </div>
                            </div>
                            <div className="col">
                                <div className="card h-75 w-80 pb-5 card_boxShadow">
                                    ...
                                    <div className="card-body">
                                        <p className="card-text" style={{ color: "#95b7b2" }}>New Product</p>
                                        <h5 className="card-title" style={{ color: "#e95598" }}> <b> Wings of Freedom...</b></h5>
                                        <h5 className="card-title" > <del>Rs.1050</del> Rs.849</h5>
                                    </div>
                                </div>
                            </div>
                            <div className="col ">
                                <div className="card h-75 w-80 pb-5 card_boxShadow">
                                    ...
                                    <div className="card-body pb-5">
                                        <p className="card-text" style={{ color: "#95b7b2" }}>New Product</p>
                                        <h5 className="card-title" style={{ color: "#e95598" }}> <b> The Boys </b></h5>
                                        <h5 className="card-title" > <del>Rs.950</del> Rs.549</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="container sellingproducts">
                        <div className="row row-cols-1 row-cols-md-4 g-3 h-50" >
                            <div className="col">
                                <div className="card h-75 w-80 pb-5 rounded card_boxShadow">
                                    <img src={sellingproduct_image1} className="card-img-top h-75" alt="..." />
                                    <div className="card-body">
                                        <p style={{ color: "#95b7b2" }} className="card-text">New Product</p>
                                        <h5 className="card-title" style={{ color: "#e95598" }}> <b> Marvel T-Shirt</b></h5>
